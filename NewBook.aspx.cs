    ...
    public partial class NewBook : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ssread.Read())
            {
                ...
                //Label5.Text = (ssread.GetInt64(4)).ToString(); ;
            }
            ssread.Close();
            conn.Close();
            ...
            //SqlConnection conn1 = new SqlConnection(ConfigurationManager.ConnectionStrings["SSConnectionString"].ConnectionString);
            //conn1.Open();
            //string query1 = "select * from EventTable";
