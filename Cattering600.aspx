<%@ Page Title="" Language="C#" MasterPageFile="~/usermaster.Master" AutoEventWireup="true" CodeBehind="Cattering600.aspx.cs" Inherits="WebApplication4.Cattering600" %>
        ...
        <ItemTemplate>
            <div style="float: left; color: black; font-family:@Gulim; font-size: large;">
                    <div style="width: 200px; height: 120px;">
                         <a href="Book.aspx?id=<%#Eval("price") %>"> </a>
