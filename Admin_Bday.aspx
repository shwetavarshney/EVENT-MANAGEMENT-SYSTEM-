<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Admin_Bday.aspx.cs" Inherits="WebApplication4.Admin_Bday" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        AutoGenerateEditButton="True" CellPadding="4" DataKeyNames="Bid" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [BdayTable]"
          InsertCommand="INSERT INTO BdayTable VALUES (@Price,@Image)"
        DeleteCommand="Delete from [BdayTable] where [Bid]=@Bid"
        UpdateCommand="Update [BdayTable] set [Image]=@Image, [Price]=@Price where [Bid]=@Bid">  
