<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BeforeEvent.aspx.cs" Inherits="WebApplication4.BeforeEvent" %>
    ...
    <table class="style1">
        <tr>
            <td class="style7" align="center" 
                ...
                &nbsp;&nbsp;&nbsp;&nbsp; Enter Event Date&nbsp;</td>
            <td class="style8">
                <asp:TextBox ID="TextBox1" runat="server" TextMode="Date" Height="30px" 
