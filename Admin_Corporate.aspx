<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Admin_Corporate.aspx.cs" Inherits="WebApplication4.Admin_Corporate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [CorporateTable]"
          InsertCommand="INSERT INTO CorporateTable VALUES (@Price,@Image)"
         UpdateCommand="UPDATE CorporateTable SET [Image]=@Image, [Price]=@Price where [Coid]=@Coid" 
         DeleteCommand="DELETE FROM CorporateTable WHERE Coid = @Coid">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        AutoGenerateEditButton="True" CellPadding="4" DataKeyNames="Coid" 
        DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:BoundField DataField="Coid" HeaderText="Coid" InsertVisible="False" 
                ReadOnly="True" SortExpression="Coid" />
